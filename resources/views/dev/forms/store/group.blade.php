...
<textarea style='width:300px; height: 100px; resize: none;' id='description' max='120' name='description'  type='text'>example of a group description</textarea>
<br>
<label for='host_comments'>host comments</label>
<textarea style='width:300px; height: 100px; resize: none;' id='host_comments' max='120' name='host_comments'  type='text'>example of a host comment for the group</textarea>
<br>
