...
class GeneralController extends Controller
{
	...
	public function __construct(){
        $this->middleware('authorization')->except(['welcome']);
        $this->middleware('host')->except(['welcome']);
	}
    ...
    public function welcome(){
        ...
        $groups = Group::select('id', 'name', 'description', 'book_id', 'group_container_id', 'route', 'host_id', 'max_size')->where('status', NULL)->get();
